...
class AddNewAddress(unittest.TestCase):
    ...
    def create_address(self, wd, addres):
        ...
        Select(wd.find_element_by_name("bday")).select_by_visible_text(addres.bday)
        wd.find_element_by_xpath("//div[@id='content']/form/select/option[13]").click()
        wd.find_element_by_name("bmonth").click()
        Select(wd.find_element_by_name("bmonth")).select_by_visible_text(addres.bmonth)
        wd.find_element_by_xpath("//div[@id='content']/form/select[2]/option[2]").click()
        wd.find_element_by_name("byear").click()
        wd.find_element_by_name("byear").clear()
        wd.find_element_by_name("byear").send_keys(addres.byear)
